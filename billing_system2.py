...
class Bill_App:
    def __init__(self, root):
        ...
        self.clear = StringVar()  # Fixed instantiation
        self.exit = StringVar()
        #===============================#
        ...
        # Total of App
        title = Label(self.root, text="Grocery Billing System",  bd=12, relief=GROOVE, fg=fg_color, bg=bg_color, font=("times new roman", 30, "bold"), pady=3)
        title.pack(fill=X)

        #====================Customer Frame======================#
        F1 = LabelFrame(self.root, text="Customer Details", font=("times new roman", 12, "bold"), fg="gold", bg=bg_color, relief=GROOVE, bd=10)
        ...
        #====================Customer Phone=====================#
        cphone_lbl = Label(F1, text="Phone No", bg=bg_color, fg=fg_color, font=("times new roman", 15, "bold"))
        ...
        #====================Food Frame=========================#
        F2_food = LabelFrame(self.root, text='Food', bd=10, relief=GROOVE, bg=bg_color, fg="gold", font=("times new roman", 13, "bold"))
        F2_food.place(x=5, y=180, width=325, height=380)

        #====================Frame Content======================#
        bath_lbl = Label(F2_food, font=("times new roman", 15, "bold"), fg=lbl_color, bg=bg_color, text="Bread")
        bath_lbl.grid(row=0, column=0, padx=10, pady=20)
        bath_en = Entry(F2_food, bd=8, relief=GROOVE, textvariable=self.bread)
        bath_en.grid(row=0, column=1, ipady=5, ipadx=5)

        #===================Candy===============================#
        face_lbl = Label(F2_food, font=("times new roman", 15, "bold"), fg=lbl_color, bg=bg_color, text="Candy")
        face_lbl.grid(row=1, column=0, padx=10, pady=20)
        face_en = Entry(F2_food, bd=8, relief=GROOVE, textvariable=self.candy)
        face_en.grid(row=1, column=1, ipady=5, ipadx=5)

        #===================Hamburger===========================#
        wash_lbl = Label(F2_food, font=("times new roman", 15, "bold"), fg=lbl_color, bg=bg_color, text="Hamburger")
        wash_lbl.grid(row=2, column=0, padx=10, pady=20)
        wash_en = Entry(F2_food, bd=8, relief=GROOVE, textvariable=self.hamburger)
        wash_en.grid(row=2, column=1, ipady=5, ipadx=5)

        #====================Hotdog=============================#
        hair_lbl = Label(F2_food, font=("times new roman", 15, "bold"), fg=lbl_color, bg=bg_color, text="Hotdog")
        hair_lbl.grid(row=3, column=0, padx=10, pady=20)
        hair_en = Entry(F2_food, bd=8, relief=GROOVE, textvariable=self.hotdog)
        hair_en.grid(row=3, column=1, ipady=5, ipadx=5)

        #====================Sandwich============================#
        lot_lbl = Label(F2_food, font=("times new roman", 15, "bold"), fg=lbl_color, bg=bg_color, text="Sandwich")
        lot_lbl.grid(row=4, column=0, padx=10, pady=20)
        lot_en = Entry(F2_food, bd=8, relief=GROOVE, textvariable=self.sandwich)
        lot_en.grid(row=4, column=1, ipady=5, ipadx=5)

        #====================Grocery Frame=======================#
        F2_grocery = LabelFrame(self.root, text='Grocery', bd=10, relief=GROOVE, bg=bg_color, fg="gold", font=("times new roman", 13, "bold"))
        F2_grocery.place(x=330, y=180, width=325, height=380)

        #====================Frame Content=======================#
        rice_lbl = Label(F2_grocery, font=("times new roman", 15, "bold"), fg=lbl_color, bg=bg_color, text="Rice")
        rice_lbl.grid(row=0, column=0, padx=10, pady=20)
        rice_en = Entry(F2_grocery, bd=8, relief=GROOVE, textvariable=self.rice)
        rice_en.grid(row=0, column=1, ipady=5, ipadx=5)       

        #=====================Food Oil===========================#
        oil_lbl = Label(F2_grocery, font=("times new roman", 15, "bold"), fg=lbl_color, bg=bg_color, text="Food Oil")
        oil_lbl.grid(row=1, column=0, padx=10, pady=20)
        oil_en = Entry(F2_grocery, bd=8, relief=GROOVE, textvariable=self.food_oil)
        oil_en.grid(row=1, column=1, ipady=5, ipadx=5)

        #=====================Salt===============================#
        daal_lbl = Label(F2_grocery, font=("times new roman", 15, "bold"), fg=lbl_color, bg=bg_color, text="Salt")
        daal_lbl.grid(row=2, column=0, padx=10, pady=20)
        daal_en = Entry(F2_grocery, bd=8, relief=GROOVE, textvariable=self.salt)
        daal_en.grid(row=2, column=1, ipady=5, ipadx=5)

        #=====================Wheat===============================#
        wheat_lbl = Label(F2_grocery, font=("times new roman", 15, "bold"), fg=lbl_color, bg=bg_color, text="Wheat")
        wheat_lbl.grid(row=3, column=0, padx=10, pady=20)
        wheat_en = Entry(F2_grocery, bd=8, relief=GROOVE, textvariable=self.wheat)
        wheat_en.grid(row=3, column=1, ipady=5, ipadx=5)

        #=====================Sugar===============================#
        sugar_lbl = Label(F2_grocery, font=("times new roman", 15, "bold"), fg=lbl_color, bg=bg_color, text="Sugar")
        sugar_lbl.grid(row=4, column=0, padx=10, pady=20)
        sugar_en = Entry(F2_grocery, bd=8, relief=GROOVE, textvariable=self.sugar)
        sugar_en.grid(row=4, column=1, ipady=5, ipadx=5)

        #==============================Other Stuff===============================#
        F2_other = LabelFrame(self.root, text='Others', bd=10, relief=GROOVE, bg=bg_color, fg="gold", font=("times new roman", 13, "bold"))
        F2_other.place(x=655, y=180, width=325, height=380)

        #=====================Frame Content========================#
        maza_lbl = Label(F2_other, font=("times new roman", 15, "bold"), fg=lbl_color, bg=bg_color, text="Gatorade")
        maza_lbl.grid(row=0, column=0, padx=10, pady=20)
        maza_en = Entry(F2_other, bd=8, relief=GROOVE, textvariable=self.gatorade)
        maza_en.grid(row=0, column=1, ipady=5, ipadx=5)

        #=====================Coke=================================#
        cock_lbl = Label(F2_other, font=("times new roman", 15, "bold"), fg=lbl_color, bg=bg_color, text="Coke")
        cock_lbl.grid(row=1, column=0, padx=10, pady=20)
        cock_en = Entry(F2_other, bd=8, relief=GROOVE, textvariable=self.coke)
        cock_en.grid(row=1, column=1, ipady=5, ipadx=5) 

        #=====================Juice================================#
        frooti_lbl = Label(F2_other, font=("times new roman", 15, "bold"), fg=lbl_color, bg=bg_color, text="Juice")
        frooti_lbl.grid(row=2, column=0, padx=10, pady=20)
        frooti_en = Entry(F2_other, bd=8, relief=GROOVE, textvariable=self.juice)
        frooti_en.grid(row=2, column=1, ipady=5, ipadx=5)

        #=====================Waffer===============================#
        cold_lbl = Label(F2_other, font=("times new roman", 15, "bold"), fg=lbl_color, bg=bg_color, text="Waffer")
        cold_lbl.grid(row=3, column=0, padx=10, pady=20)
        cold_en = Entry(F2_other, bd=8, relief=GROOVE, textvariable=self.waffer)
        cold_en.grid(row=3, column=1, ipady=5, ipadx=5)

        #=====================Biscuits=============================#
        bis_lbl = Label(F2_other, font=("times new roman", 15, "bold"), fg=lbl_color, bg=bg_color, text="Biscuits")
        bis_lbl.grid(row=4, column=0, padx=10, pady=20)
        bis_en = Entry(F2_other, bd=8, relief=GROOVE, textvariable=self.biscuits)
